...
//llamas elementos por id
var principal = document.getElementById("principal")
console.log(principal)
console.log("getElementById", principal)

//llama elementos por etiqueta
var etiquetas = document.getElementsByTagName("p") 
console.log(etiquetas);  //es como un array pero de estilos, no de strings
console.log(etiquetas[2])//se puede llamar igual que a los arrays

//llama por clases de html
var elementosClase = document.getElementsByClassName("rojo")
console.log("getElementsByClassName", elementosClase)

//llama por selector de css 
...
console.log("querySelectorAll", todosElementosQuery) //USAMOS MAS ESTA!
...
//es utilizar los atributos de HTML como propiedades de objeto
...
// var clase = elemento.className; //asi es en Js
// // var clase = elemento.class // esto es undefined
// console.log(clase); // rojo
// clase = elemento.getAttribute('class'); // asi es en hmtl
