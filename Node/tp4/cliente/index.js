...
//         return res.json();
//     })
//     //users no tiene que ver con la variable con la del servidor, sino es el nombre que le puse al parametro
//     .then(function (users) {
//         employee = users;
//         return users.map(function (t) {
...
//     fetch(`http://localhost:4000/api/users/${id}/complete`, {
